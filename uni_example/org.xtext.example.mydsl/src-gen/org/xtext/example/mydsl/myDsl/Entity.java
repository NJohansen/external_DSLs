 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.Entity#getBase <em>Base</em>}</li>
...
public interface Entity extends Declaration
{
   ...
   * @see #setBase(Entity)
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getEntity_Base()
   * @model
   * @generated
   */
  Entity getBase();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.Entity#getBase <em>Base</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
