 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.EntityImpl#getBase <em>Base</em>}</li>
...
public class EntityImpl extends DeclarationImpl implements Entity
{
  ...
  public Entity getBase()
  {
    if (base != null && base.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MyDslPackage.ENTITY__BASE, oldBase, base));
      }
    }
    return base;
  }
  ...
  public void setBase(Entity newBase)
  {
    ...
    base = newBase;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ENTITY__BASE, oldBase, base));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.ENTITY__NAME:
        return getName();
      case MyDslPackage.ENTITY__BASE:
